...
<div class="left_side clearfix v_centered">
	...
	<div class="v_centered">
		<span><?php echo $t->_('sort_text') ?></span>
		<div class="custom_select sort_select">
			<select name="sort" class="change-value">	
				<option value="1" <?php echo $sortby == 1 ? 'selected' : ''; ?>><?php echo $t->_('sort_price_asc') ?></option>
				<option value="2" <?php echo $sortby == 2 ? 'selected' : ''; ?>><?php echo $t->_('sort_price_desc') ?></option>
				<option value="3" <?php echo $sortby == 3 ? 'selected' : ''; ?>><?php echo $t->_('sort_product_newest') ?></option>
			</select>
		</div>
	</div>
	<!-- - - - - - - - - - - - - - End of sort by - - - - - - - - - - - - - - - - -->
	...
	<!-- <div class="v_centered">
		<span><?php echo $t->_('show_text') ?></span>
	...
	<div class="table_row">
		...
		<?php
			for($j = 0; $j < 3; $j++){
				...
				{ ?>
					{{ partial('partials/product-item-list',['item':data.items[i+j]])}}
				<?php } else{ ?>
