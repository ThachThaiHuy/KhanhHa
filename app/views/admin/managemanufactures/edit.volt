    ...
    <div class="row">
        <div class="hpanel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="addCategory" action="/admin/managemanufactures/edit/{{data.id}}">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-6">
                            <input maxlength="100" name="name" type="text" class="form-control" id="name" value="<?php echo $data->name?>">
                        </div>
                    </div>
                    <div class="form-group">
