    ...
    <div class="row">
        <div class="hpanel">
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="addSite" action="/user/managesites/add">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Site Name</label>
                        <div class="col-sm-6">
                            <input name="site_name" type="text" class="form-control" id="site_name" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input name="sub_domain" type="text" class="form-control" id="sub_domain" maxlength="50" placeholder="">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="1" name="use_domain" id="use_domain">Use other domain
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <input name="domain" type="text" class="form-control" id="domain" maxlength="50" placeholder="">
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-6">
                            <input name="email" type="text" class="form-control" id="email" maxlength="100" placeholder="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Phone</label>
                        <div class="col-sm-6">
                            <input name="phone" type="text" class="form-control" id="phone" maxlength="15" placeholder="">
                        </div>
                    </div>
                     <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input name="googleplus" type="text" class="form-control" id="googleplus">
                        </div>
                    </div>
                    <div class="form-group">
