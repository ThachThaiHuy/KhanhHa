    ...
    <div class="row">
        <div class="hpanel">
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="/user/manageuserposts/add" method="post" id="addPosts" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" name="description" id="description"  maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
