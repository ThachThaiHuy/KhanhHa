    ...
    <div class="row">
        <div class="hpanel">
            <div class="panel-body">
                <form class="form-horizontal" method="post" id="addCategory" action="/admin/managecategorydetails/add">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Category Detail Name</label>
                        <div class="col-sm-6">
                            <input name="categorydetail_name" type="text" class="form-control" id="categorydetail_name" maxlength="100">
                        </div>
                    </div>
                    <div class="form-group">
