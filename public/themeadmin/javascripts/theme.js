										...
										'<div class="row">',
											'<div class="col-xs-6">',
												'<p class="mt-xs mb-none">',
													'<a href="/admin/logout" class="btn btn-primary">Logout <i class="fa fa-sign-out"></i> </a>',
												'</p>',
											'</div>',
											'<div class="col-xs-6 text-right">',
												'<button type="submit" class="btn btn-primary">Unlock <i class="fa fa-unlock" aria-hidden="true"></i></button>',
											'</div>',
										'</div>',
									'</form>',
								'</div>',
