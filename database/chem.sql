...
-- Dumping data for table chemdb.abouts: ~1 rows (approximately)
...
INSERT INTO `banner` (`id`, `image`, `animtion`, `text`, `text2`, `position_text`, `animtion_text_1`, `animtion_text_2`, `link`, `deleted`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
	(1, '/public/files/images/panel_1.png', 'shake', 'HACO chuyên cung cấp các loại phụ gia trong thực phẩm', '-	Tinh bột', 'slide_style_left', 'bounceInDown', 'bounceInDown', '#', 0, '2016-04-25 12:52:33', '2018-12-08 11:34:51', 0, 1),
	(2, '/public/files/images/panel_3.png', 'swing', 'Test 1 banner', '&lt;p&gt;Cung cấp c&amp;aacute;c sản phẩm từ nha đam, thạch dừa v&amp;agrave; t&amp;ugrave; tr&amp;a', 'slide_style_left', 'flipInY', 'flipInX', '#', 0, '2016-07-01 10:39:28', '2018-12-13 23:01:40', 1, 1),
	(5, '/images/banner/panel_4.jpeg', NULL, 'cvbcvbc', 'dfgdfgdfg', NULL, NULL, NULL, '#', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0),
	(6, '/public/files/images/panel_2.png', 'rotateInDownLeft', ' ', 'Cung cấp các dung môi, hóa chất công nghiệp cho các ngành sản xuát sơn, dệt nhuộm, giấy……', 'slide_style_right', 'slideInDown', 'flipInX', NULL, 0, '2018-04-23 22:15:38', '2018-12-08 13:50:03', 3, 1);
...
-- Dumping data for table chemdb.contacts: ~8 rows (approximately)
...
-- Dumping data for table chemdb.partner: ~4 rows (approximately)
...
-- Dumping data for table chemdb.users: ~3 rows (approximately)
