...
<script src="/admin/vendor/morris.js/morris.js"></script>
...
<script src="/admin/javascripts/theme.js"></script>

<!-- Theme Custom -->
<script src="/admin/javascripts/theme.custom.js"></script>

<!-- Theme Initialization Files -->
<script src="/admin/javascripts/theme.init.js"></script>